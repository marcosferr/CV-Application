...
import FormSkills from "./form-sections/FormSkills";
import FormLanguage from "./form-sections/FormLanguage";
import FormInterests from "./form-sections/FormInterest";
const Main = () => {
  const desc = [
  ...
  return (
    <main>
      ...
      <FormSkills description={desc[3]} />
      <FormLanguage description={desc[3]} />
      <FormInterests description={desc[3]} />
    </main>
  );
};
